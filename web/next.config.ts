...
const nextConfig: NextConfig = {
  ...
  output: "standalone",
  turbopack: {
    // web/ is an independent package with its own lockfile/node_modules, not
    // part of a pnpm workspace — but the root-level pnpm-lock.yaml (there for
    // the repo's husky/Biome orchestration) makes Turbopack's multi-lockfile
