...
// both resolve the URL the same way, so applying migrations against a deployed
...
//
// Empty string rather than a throw when unset: `drizzle-kit generate` diffs the
// schema against the checked-in snapshot and needs no database at all.
