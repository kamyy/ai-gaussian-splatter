...
// Drawn pointing down with the bar below. SplatCarousel.tsx and PhotoFilmstrip.tsx rotate it per direction (180/0 for
// the vertical carousel, 90/-90 for the horizontal one).
