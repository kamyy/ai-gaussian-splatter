...
| Tear down | Turn the job off and wait for in-flight CI on `main`, or the next push (or an already-started run) redeploys into the empty state ([Tearing down](../../../RUNBOOK.md#tearing-down)). |
