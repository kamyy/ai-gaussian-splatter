...
Needs the local Postgres running (`scripts/dev/db-up.sh`) and the `DATABASE_*` variables from `web/.env`. See [Web (frontend + REST API)](../../../RUNBOOK.md#2-web-frontend--rest-api) if it isn't up.
