...
- **Keep the ACM cert declared inline in `infra/stacks/web_stack.py`** so it issues in the ALB's region (`us-west-2`; see [`ARCHITECTURE.md`](ARCHITECTURE.md)). Same hostname in another region is normal (certs are free).
